...
const hashFailFmt = "hash '%s' does not match expected hash '%s'"
...
func TestHMACBasedHash(t *testing.T) {
	...
	expected := "eyJuYmYiOjE1OTk5Mzk2MDAsImV4cCI6MTU5OTk0ODYwMCwiaXAiOlsiMTkyLjE2OC4wLjMxIl0sInVzYWdlc19BVCI6MTF9L3Lomh4pL9-cwcig05q2_MSuKFRsr6CMVw2iUcQjRAhdOt8qGVwg1R08eICUg8sKiwNDpXr92k1iWIMDcvuA_Q=="
	if hash != expected {
		t.Errorf(hashFailFmt, hash, expected)
	}
}
