(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.FaUserAgent = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
"use strict";function fas(a){return{name:a,style:"fas"}}function fab(a){return{name:a,style:"fab"}}Object.defineProperty(exports,"__esModule",{value:!0}),exports.DefaultOptions={prefix:"fa-",icons:{browser:{androidBrowser:fab("android"),internetExplorer:fab("internet-explorer"),operaCoast:fab("opera"),blackBerry:fab("blackberry"),chrome:fab("chrome"),chromium:fab("chrome"),edge:fab("edge"),firefox:fab("firefox"),googlebot:fab("google"),opera:fab("opera"),phantomJS:fas("ghost"),safari:fab("safari")},os:{android:fab("android"),blackBerry:fab("blackberry"),iOS:fab("apple"),linux:fab("linux"),macOS:fab("apple"),playStation4:fab("playstation"),windows:fab("windows")},platform:{desktop:fas("desktop"),mobile:fas("mobile-alt"),tablet:fas("tablet-alt"),tv:fas("tv")}},default:{browser:fas("question"),os:fas("question"),platform:fas("question")}};

},{}],2:[function(require,module,exports){
"use strict";function __export(e){for(var r in e)exports.hasOwnProperty(r)||(exports[r]=e[r])}Object.defineProperty(exports,"__esModule",{value:!0}),__export(require("./lib"));

},{"./lib":3}],3:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var Bowser=require("bowser"),default_options_1=require("./default-options");function sanitizeName(e){return e.replace(" ","").toLowerCase()}function compareName(e,t){return sanitizeName(e)===sanitizeName(t)}function getBaseIcon(e,t,n){var r=n.icons[e],o=t&&Object.keys(r).find(function(e){return compareName(e,t)});return o?r[o]:n.default[e]}function getPrefixedName(e,t){return""+t.prefix+e.name}function getIconHtml(e,t){return'<i class="'+e.style+" "+getPrefixedName(e,t)+'"/>'}function getIcon(e,t,n){var r=getBaseIcon(e,t,n);return{name:r.name,style:r.style,html:getIconHtml(r,n)}}function faUserAgent(e,t){var n=t?t(default_options_1.DefaultOptions):default_options_1.DefaultOptions,r=Bowser.parse(e);return{browser:getIcon("browser",r.browser.name,n),os:getIcon("os",r.os.name,n),platform:getIcon("platform",r.platform.type,n)}}exports.faUserAgent=faUserAgent;

},{"./default-options":1,"bowser":4}],4:[function(require,module,exports){
