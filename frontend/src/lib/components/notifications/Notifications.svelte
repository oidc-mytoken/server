...
<div class="notifications-container">
	...
	<div class="d-flex justify-content-between align-items-center mb-4">
		...
		<button class="btn btn-primary btn-sm" style:display={activeTab === 'notifications' ? undefined : 'none'} onclick={() => showCreateNotificationModal = true}>
			<i class="fas fa-plus me-1"></i>
			New Notification
		</button>
		<button class="btn btn-primary btn-sm" style:display={activeTab === 'calendars' ? undefined : 'none'} onclick={() => calendarListRef?.openCreateModal()}>
			<i class="fas fa-plus me-1"></i>
			New Calendar
		</button>
		</div>
	...
	{:else}
		<!-- Content -->
		<div style:display={activeTab === 'notifications' ? undefined : 'none'}>
			<NotificationList 
				{notifications}
				tokens={allTokens}
		...
		<div style:display={activeTab === 'calendars' ? undefined : 'none'}>
			<CalendarList 
