// Country data with names and ISO 3166-1 alpha-2 codes
...
export const countries: Country[] = [
	...
	{ name: "Saint Martin (French)", code: "MF" },
...
// Create a map from code to country for easy lookup
...
export function getCountryName(code: string): string {
	return countriesByCode[code.toUpperCase()]?.name ?? code;
}
